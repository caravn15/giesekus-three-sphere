function [flowmax,flowavg] = PlotVelocityZoomed(Utime_ind,X,ft,Utime,refFactor,plotStreams,Ulim)
...
if plotStreams == 1
    stream = streamslice(xvf,yvf,ux,uy,2);
